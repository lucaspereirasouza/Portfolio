...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://github.com/lucaspereirasouza',
    email: 'lucaspereiradesouza2163@outlook.com',
    linkedin: 'https://www.linkedin.com/in/lucas-pereira0/',
  ...
  giscus: {
    repo: 'lucaspereirasouza/portfolio',
    repoId: 'R_kgDOPNnBig',
    category: 'Giscus',
